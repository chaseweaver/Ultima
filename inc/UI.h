...
public:
	...
	void create_window_spawn(std::string, int, int, int, int, int, int, int);
	void create_window(std::string, int, int, int, int, int, int, int);
	void create_window_spawn(std::string, int, int, int, int, int);
	void create_window(std::string, int, int, int, int, int);
	void create_window_spawn(int, int, int, int, int);
	void create_window(int, int, int, int, int);
	void create_window_lock_spawn(std::string, int, int, int, int, int, int, int);
	void create_window_lock(std::string, int, int, int, int, int, int, int);
